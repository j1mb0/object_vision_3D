/*
 * Adapted for ROS use by James Schiffer
 *
 * Source: global_nn_classifier.h From PCL Trunk
 * global.h
 *
...
#ifndef REC_FRAMEWORK_CUS_GLOBAL_PIPELINE_H_
#define REC_FRAMEWORK_CUS_GLOBAL_PIPELINE_H_
...
namespace obj_seg
{
  namespace rec_3d_framework
  {
    ...
    template<template<class > class Distance, typename PointInT, typename FeatureT>
      class GlobalNNPipeline : obj_seg::rec_3d_framework::GlobalClassifier<PointInT>
      {
      ...
      protected:
        ...
        typename boost::shared_ptr<pcl::rec_3d_framework::GlobalEstimator<PointInT, FeatureT> > estimator_;
      ...
      public:
         ...
         */
        void
        setDataSource (typename boost::shared_ptr<pcl::rec_3d_framework::Source<PointInT> > & source)
        {
          source_ = source;
        }
        ...
        void
        setFeatureEstimator (typename boost::shared_ptr<pcl::rec_3d_framework::GlobalEstimator<PointInT, FeatureT> > & feat)
        {
          estimator_ = feat;
        }
...
#endif /* REC_FRAMEWORK_CUS_GLOBAL_PIPELINE_H_ */
