...
#ifndef CUS_REC_FRAMEWORK_OURCVFH_ESTIMATOR_H_
#define CUS_REC_FRAMEWORK_OURCVFH_ESTIMATOR_H_
...
template<typename PointInT, typename FeatureT>
  class OURCVFHEstimator : public pcl::rec_3d_framework::GlobalEstimator<PointInT, FeatureT>
  {

  protected:
    typedef typename pcl::PointCloud<PointInT>::Ptr PointInTPtr;
    using pcl::rec_3d_framework::GlobalEstimator<PointInT, FeatureT>::normal_estimator_;
    using pcl::rec_3d_framework::GlobalEstimator<PointInT, FeatureT>::normals_;
  ...
  public:
              ...
              std::vector<Eigen::Vector3f, Eigen::aligned_allocator<Eigen::Vector3f> > & centroids)
    {
      ...
      cvfh.setMinPoints (min_points_);
//std::cout << "Setting min_points to " << min_points_ << std::endl;
...
std::cout << "Setting min_points to " << min_points_ << std::endl;
      ...
      //float vpx, vpy, vpz;
      //cvfh.getViewPoint(vpx, vpy, vpz);
      //std::cout << "Viewpoint: x = " << vpx << ", y = " << vpy << ", z = " << vpz << std::endl;
    }
...
#endif /* CUS_REC_FRAMEWORK_OURCVFH_ESTIMATOR_H_ */
