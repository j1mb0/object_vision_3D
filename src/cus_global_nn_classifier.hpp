...
template<template<class > class Distance, typename PointInT, typename FeatureT>
  void
  obj_seg::rec_3d_framework::GlobalNNPipeline<Distance, PointInT, FeatureT>::loadFeaturesAndCreateFLANN ()
  {
...
template<template<class > class Distance, typename PointInT, typename FeatureT>
  void
  obj_seg::rec_3d_framework::GlobalNNPipeline<Distance, PointInT, FeatureT>::nearestKSearch (flann::Index<DistT> * index, const flann_model &model,
...
template<template<class > class Distance, typename PointInT, typename FeatureT>
  void
  obj_seg::rec_3d_framework::GlobalNNPipeline<Distance, PointInT, FeatureT>::classify ()
  {

pcl::ScopeTime classify_process ("Classifying frame processing ------------- ");
    categories_.clear ();
    confidences_.clear ();
...
template<template<class > class Distance, typename PointInT, typename FeatureT>
  void
  obj_seg::rec_3d_framework::GlobalNNPipeline<Distance, PointInT, FeatureT>::initialize (bool force_retrain)
  {
