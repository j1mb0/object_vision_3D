...
template<template<class > class Distance, typename PointInT, typename FeatureT>
  void
  cus_rec_3d_framework::GlobalNNCVFHRecognizer<Distance, PointInT, FeatureT>::getPose (ModelT & model, int view_id, Eigen::Matrix4f & pose_matrix)
  {
    ...
    pcl::rec_3d_framework::PersistenceUtils::readMatrixFromFile (dir.str (), pose_matrix);
  }

template<template<class > class Distance, typename PointInT, typename FeatureT>
  bool
  cus_rec_3d_framework::GlobalNNCVFHRecognizer<Distance, PointInT, FeatureT>::getRollPose (ModelT & model, int view_id, int d_id,
...
template<template<class > class Distance, typename PointInT, typename FeatureT>
  void
  cus_rec_3d_framework::GlobalNNCVFHRecognizer<Distance, PointInT, FeatureT>::getCentroid (ModelT & model, int view_id, int d_id,
                                                                                            Eigen::Vector3f & centroid)
  {
    ...
    pcl::rec_3d_framework::PersistenceUtils::getCentroidFromFile (dir.str (), centroid);
  }

template<template<class > class Distance, typename PointInT, typename FeatureT>
  void
  cus_rec_3d_framework::GlobalNNCVFHRecognizer<Distance, PointInT, FeatureT>::getView (ModelT & model, int view_id, PointInTPtr & view)
  {
...
template<template<class > class Distance, typename PointInT, typename FeatureT>
  void
  cus_rec_3d_framework::GlobalNNCVFHRecognizer<Distance, PointInT, FeatureT>::loadFeaturesAndCreateFLANN ()
  {
      ...
      for (bf::directory_iterator itr_in (inside); itr_in != end_itr; ++itr_in)
      {
        ...
        if (strs[0] == "descriptor")
        {
          ...
          if (use_cache_)
          {
            ...
            Eigen::Matrix4f pose_matrix;
            pcl::rec_3d_framework::PersistenceUtils::readMatrixFromFile (dir_pose.str (), pose_matrix);
...
template<template<class > class Distance, typename PointInT, typename FeatureT>
  void
  cus_rec_3d_framework::GlobalNNCVFHRecognizer<Distance, PointInT, FeatureT>::nearestKSearch (flann::Index<DistT> * index, const flann_model &model,
...
template<template<class > class Distance, typename PointInT, typename FeatureT>
  void
  cus_rec_3d_framework::GlobalNNCVFHRecognizer<Distance, PointInT, FeatureT>::recognize ()
  {
...
template<template<class > class Distance, typename PointInT, typename FeatureT>
  void
  cus_rec_3d_framework::GlobalNNCVFHRecognizer<Distance, PointInT, FeatureT>::initialize (bool force_retrain)
  {
        ...
        for (size_t v = 0; v < models->at (i).views_->size (); v++)
        {
          ...
          for (size_t j = 0; j < signatures.size (); j++)
          {
            if (valid_trans[j])
            {
              ...
              pcl::rec_3d_framework::PersistenceUtils::writeMatrixToFile (path_pose.str (), transforms[j]);
            }
          }
        }
      }
